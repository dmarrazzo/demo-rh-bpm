<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("supplier");
					i++;
...
<div id="container">
	<div id="header">
		User Task Form: OrderManagement.QuoteOrder
	</div>
	<div id="content">
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="supplier" type="text" class="textbox" id="supplier" value="${supplier}" />
                            		</div>
